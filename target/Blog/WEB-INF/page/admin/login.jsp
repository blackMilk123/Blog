...
<head>
    ...
    <style>
        .login-bg{width: 100%;min-height: 600px;height: calc(100vh - 100px - 100px);background-image: url("http://pcvisishu.bkt.clouddn.com/FkWRij5GH1tz-YG_rKwwxSYNz-AG");background-size: auto 100%;background-position: 45% center;background-repeat: no-repeat;position: relative;}
        .login-form{position: absolute;width: 288px;right:260px;background: #fff;padding: 20px 38px 0;top:18%; right: 35%}
        ...
        .button.login{background-color: #eaf6fe;color: #108cee;width: 100%;border-radius: 3px;font-size: 14px;height: 40px;line-height: 40px;}
    ...
    <form id="login">
        <div class="login-form">
            ...
            <div class="login-item">
                <input type="text" class="login-text" id="username" name="username" data-type="必填" placeholder="用户名" />
            </div>
            <!--密码-->
            <div class="login-item">
