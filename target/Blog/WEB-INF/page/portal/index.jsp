...
<link href="${pageContext.request.contextPath}/static/javaex/pc/css/index.css" rel="stylesheet" >
</head>
						...
						<div class="block block2">
							<div class="grid-5-7" style="height: 230px;">
								...
								<div class="main-15">
                                    ...
                                    <div class="day"><fmt:formatDate value="${entity.createTime}"></fmt:formatDate></div>
								</div>
							</div>
						</div>
					</c:forEach>
